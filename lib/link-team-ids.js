...
const linkTeamIds = async (teamsObject) => {
  ...
  teamsObjectKeys.forEach((teamId) => {
    ...
    payload[teamsObject[teamId].teamName] = {
      insertOne: {
        document: {
          teamCoreId: '',
          teamChallongeId: teamsObject[teamId].teamChallongeId,
          teamParticipantChallongeId: teamsObject[teamId].teamParticipantChallongeId,
        },
      },
    };
  });
